classdef set_grid < handle
    ...
    % t_length    total computational time 
    ...
    properties (GetAccess = public, SetAccess = private)
           ...
           function mgrid = set_grid(varargin)  
               ...
               switch nargin
                   ...
                   case 6
                       ...
                       % calculate the grid points in x- and z- direction
                       mgrid.num_x = round(mgrid.x_length/mgrid.dx);
                   ...
                   case 8
                       ...
                       mgrid.num_x = round(mgrid.x_length/mgrid.dx);
                       mgrid.num_y = round(mgrid.y_length/mgrid.dy);        
                       mgrid.num_z = round(mgrid.z_length/mgrid.dz);  
       ...
       methods (Access = 'protected', Static = true) 
           ...
           % define the wavevector in the x/y/z direction
           ...
           function w_vec = makeOmega(dt, num_t)
               if mod(num_t,2) % odd length(t)
                   ...
                   w_vec = 1/dt *2*pi* (-num_t/2:num_t/2-1)/num_t;
               end
