function [M_linear, Ktemp, Ktemp2, cw] = Mterm2D_Mfund(mgrid, medium, omega_c)
...
% prepare for calculation wavevector in y direction with constant speed of sound       
Ktemp    = (omega_c^2./medium.c0^2) - (mgrid.kx.').^2;  

% prepare for calculation wavevector in y direction with heterogeneous
% speed of sound
