function [M_linear, Ktemp2, cw2, cw] = Mterm2D_Msec(mgrid, medium, omega_c)

% DESCRIPTION:
% M term calculation for 2D second-harmonic pressure simulation
% frequency

% USAGE:
% [M_linear, Ktemp2, cw2, cw] = Mterm2D_secd(mgrid, medium, omega_c)
...
Ktemp2   = ((omeagc2).^2./(medium.c0).^2) - mgrid.kx.'.^2;
