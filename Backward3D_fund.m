function [P_fundamental] = Backward3D_fund(mgrid, medium, excit_p, omega_c, ...
...
% USAGE:
% [P_fundamental] = Backward3D_fund(mgrid, medium, excit_p, omega_c, ...
%                   reflection_order, varargin)
...
if reflection_order ~=0 && (reflection_option == 1)
    ...
    if MDMC == 1
        reflection = BMReflection3D_fund(mgrid, medium, p_ref, ...
                     M_linear, K, K2, cw, omega_c,...
                     reflection_order, excit_p, MDMS);
    else
        reflection = BReflection3D_fund(mgrid, medium, p_ref, ...
